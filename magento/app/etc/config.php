...
return [
    ...
    'scopes' => [
        ...
        'stores' => [
            ...
            'en_store_view' => [
                ...
                'website_id' => '3',
                'group_id' => '2',
                'name' => 'English Store View',
                'sort_order' => '0',
                'is_active' => '1',
            ],
            'sp_store_view_test' => [
                'store_id' => '4',
                'code' => 'sp_store_view_test',
                'website_id' => '2',
                'group_id' => '3',
                'name' => 'Spanish store view',
                'sort_order' => '0',
    ...
    'themes' => [
        ...
        'frontend/Pameloski/theme101' => [
            'parent_id' => 'Magento/luma',
            'theme_path' => 'Pameloski/theme101',
            'theme_title' => 'Theme101',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'Pameloski/theme101',
        ],
        'frontend/Kalicr/test' => [
            'parent_id' => 'Magento/blank',
            'theme_path' => 'Kalicr/test',
            'theme_title' => 'Test',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
        ...
        'frontend/Kalicr/production' => [
            'parent_id' => 'Magento/luma',
            'theme_path' => 'Kalicr/production',
            'theme_title' => 'Production',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'Kalicr/production',
        ],
    ],
    /**
...
Disallow: /*SID=
        ...
        'websites' => [
            ...
            'prod' => [
                'design' => [
                    'theme' => [
                        'theme_id' => 'frontend/Kalicr/production',
                    ],
                ],
            ],
        ],
